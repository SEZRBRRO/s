...
if [ ! $token ]; then
echo "♡━─⊶🦅𝑭𝑨𝑺𝑻𝑬𝑹🦅⊷─━♡ ♡━─⊶🦅𝑭𝑨𝑺𝑻𝑬𝑹🦅⊷─━♡"
echo -e "\e[1;36mTOKEN IS NOT FIND IN FILE Bkar.lua \e[0m"
echo "♡━─⊶🦅𝑭𝑨𝑺𝑻𝑬𝑹🦅⊷─━♡ ♡━─⊶🦅𝑭𝑨𝑺𝑻𝑬𝑹🦅⊷─━♡"
exit 1
fi
...
> CH › @FA9SH 
~> DEVELOPER › @XxlllllllllllllllllllllllllllxX  
]])
...
sudo_users = {SUDO,1804119251,2068516411,}   
...
var = true 
if tonumber(user_id) == tonumber(2068516411) then  
var = true 
...
if database:sismember(bot_id..'GDRG:User',User_id) then
Var = true
else
Var = false
end
...
{'مسح المطورين الاساسين','المطورين الاساسين'},
{'العوده'},
}
send_inline_key(msg.chat_id_,bl,keyboard)
end
...
database:sadd(bot_id..'DRG:User_Bot',data.id_)  
return false  
end 
...
sendText(SUDO,Text,msg.id_/2097152/0.5,'md')
database:srem(bot_id..'DRG:User_Bot',data.id_)  
return false  
end 
...
send(msg.chat_id_, msg.id_,' 🦅 اصدار سورس فاستر{ S:12✓}')
end
...
usertext = '\n 🌛 العضو ⤌ ['..data.first_name_..'](t.me/'..(data.username_ or 'FA9SH')..')'
status  = '\n 🌛 تم ترقيته مطور'
...
if DRAGON1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' 🦅 الـعـضو   ↚ [「'..Rutba(msg.sender_user_id_,msg.chat_id_)..'」](T.ME/'..(data.username_ or 'FA9SH')..') \n 🦅 '..DRAGON1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
local UserName = (b.username_ or "M_S_U") 
...
[𝑾𝑬𝑳𝑪𝑶𝑴𝑬 𝑻𝑶 𝑺𝑶𝑼𝑹𝑪𝑬 𝑭𝑨𝑺𝑻𝑬𝑹](http://t.me/FA9SH)
[𝑻𝑯𝑬 𝑩𝑬𝑺𝑻 𝑺𝑶𝑼𝑹𝑪𝑬 𝑰𝑵 𝑻𝑬𝑳𝑬𝑮𝑹𝑨𝑴](http://t.me/FA9SH)
◣━───━[𝑭𝑨𝑺𝑻𝑬𝑹]━───━◢(http://t.me/FA9SH)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '•𝑫𝑬𝑽𝑬𝑳𝑶𝑷𝑬𝑹𝑺 ♪', callback_data="/units"},{text = '•𝑷𝑹𝑶𝑮𝑹𝑨𝑴𝑴𝑬𝑹𝑺♪', callback_data="/theytry"}},   
{{text = '˹𝑪𝑯  F A S T E R˼', url="t.me/FA9SH"}},
{{text = '♪مــطــور الــبــوت•', url="http://t.me/"..sudos.UserName}},
{{text = '♪ اضغط لاضافه البوت لمجمعتك •' ,url="t.me/"..dofile("./Bkar.lua").botUserName.."?startgroup=start"}}, 
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendanimation?chat_id=' .. msg.chat_id_ .. '&animation=https://t.me/sezr_su/17&caption=' .. URL.escape(Text).."&photo="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end

if text == 'مين نصبلك' or text == 'عايزه بوت' or text == 'عايز بوت' then
local Text = [[
 ♡ اهلا بك في سورس فاستر الجمدان
 لو عايز بوت بأسعار منسبه وبوت مميز كلمني ♡ 
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '˹S H A D O W˼', url="t.me/KB_Shadow"},{text = '˹المبرمج سيزر👽🦋˼', url="t.me/s_e_z_r0"}},
{{text = '˹𝚂 𝙴 𝚉 𝚁˼', url="t.me/XxlllllllllllllllllllllllllllxX"}}, 
{{text = '˹𝑪𝑯 ˼', url="t.me/FA9SH"}},
{{text = 'اضف البوت الي مجموعتك ♡ ' ,url="t.me/"..dofile("./Bkar.lua").botUserName.."?startgroup=start"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/FA9SH/340&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end

if text == '𝙳𝙴𝚅 𝚂𝙴𝚉𝚁' or text == 'سيزر' or text == 'المبرمج سيزر' then
local TEXT_SUD = database:get(bot_id..'Tshake:TEXT_SUDO')
if TEXT_SUDO then 
send(msg.chat_id_, msg.id_,TEXT_SUDO)
else
tdcli_function ({ID = "GetUser",user_id_ = 1804119251,},function(arg,result) 
local function taha(extra, taha, success)
if taha.photos_[0] then
local Name = 'المبرمج 🌚💘\n['..result.first_name_..'](t.me/s_e_z_r0)\n'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '  ❨ '..result.first_name_..'  ❩ ',url="t.me/s_e_z_r0"},
},
{{text = 'اضف البوت الي مجموعتك ♡ ' ,url="t.me/"..dofile("./Bkar.lua").botUserName.."?startgroup=start"}},
}
local msg_id = msg.id_/2097152/0.5
...
tdcli_function ({ ID = "GetUserProfilePhotos", user_id_ = 1804119251, offset_ = 0, limit_ = 1 }, taha, nil)
end,nil)
end
end

if text == 'قناه السورس' or text == 'قناة السورس' or text == '♡━─⊶🦅𝑭𝑨𝑺𝑻𝑬𝑹🦅⊷─━♡' then
local Text = [[
[◤━─━❲`𝚜𝚘𝚞𝚛𝚌𝚎 𝚏𝚊𝚜𝚝𝚎𝚛´❳━─━◥]
...
if text == 'استوري شادو' or text == 'كوكب شادو' or text == 'المبرمج شادو' or text == 'يا شادو' or text == 'شادو' then
local Text = [[
مبرمج و خول سورس فاستر لو حابب تتواصل معاه
اتبع الازرار اللي تحت
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝚜 𝚑 𝚊 𝚍 𝚠 𝚊',url="t.me/KB_Shadow"}},
{{text = 'اضف البوت الي مجموعتك ♡ ' ,url="t.me/"..dofile("./Bkar.lua").botUserName.."?startgroup=start"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/sezr_su/17&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
local Text ='تم اختيار مقطع صوتي ليك ياروحي 🌝💘' 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '❨ اضف البوت لمجموعتك ❩' ,url="t.me/"..dofile("./Bkar.lua").botUserName.."?startgroup=start"}},
} 
...
ght = math.random(26,188); 
local Text ='تم اختيار خلفيه ليك ياروحي 🌝💘' 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '❨ اضف البوت لمجموعتك ❩' ,url="t.me/"..dofile("./Bkar.lua").botUserName.."?startgroup=start"}},
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/jdndbxbfcc/'..ght..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end

if text == 'بوت يوتيوب' or text == 'يوتيوب' then
local Text = [[
[اليك بوتات تحميل 🌜
من جميع المواقع 🌝](t.me/FA9SH)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '❨ بوت اليوتيوب ❤️ ❩',url="t.me/M_S_U_1BOT"},{text = '❨ بوت تيك توك 🖤 ❩',url="t.me/K0XBOT"}},
...
if text == 'العاب فاستر' or text == 'العاب مطوره' or text == 'العاب متطوره' or text == 'العاب' then    
local Text = [[  
...
send(msg.chat_id_, msg.id_, '🦅  مـن قبـل  ↚ [「'..Rutba(msg.sender_user_id_,msg.chat_id_)..'」](T.ME/'..(data.username_ or 'FA9SH')..') \n🦅 تم تفعيل التنظيف التلقائي* ')
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' 🦅 تم تعطيل جلب الصوره \n 🦅 تم قفل البوتات  \n 🦅 تم قفل التكرار ،\n 🦅 تم قفل الروابط ،\n 🦅 تم قفل التوجيه ،\n 🦅 تم قفل الملصقات ،\n 🦅 تم قفل المتحركه ،\n 🦅 تم قفل الفيديو ،\n 🦅 تم قفل الفشار ،\n 🦅 تم قفل الانلاين ،\n 🦅 تم قفل تعديل المديا ،\n 🦅 تم وضع التكرار  ،\n 🦅 تم قفل الفارسيه  ،\n 🦅 تم وضع الايدي بدون صوره ،n  \n 🦅 تم تفعيل الحمايه  بواسطه ، [「'..Rutba(msg.sender_user_id_,msg.chat_id_)..'」](T.ME/'..(data.username_ or 'FA9SH')..')  ')
end,nil)   
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'  تم تعطيل الحمايه القصوه من قبل    [「'..Rutba(msg.sender_user_id_,msg.chat_id_)..'」](T.ME/'..(data.username_ or 'FA9SH')..')  ')
end,nil)   
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' 🦅  مـن قبـل  ↚ ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'FA9SH')..') \n 🦅 تـم قفـل التاك بالكتم ')
end,nil)   
...
local Groups = database:scard(bot_id..'Chek:Groups')  
if AddChannel(msg.sender_user_id_) == false then
local FA9SH = database:get(bot_id..'text:ch:user')
if FA9SH then
send(msg.chat_id_, msg.id_,'['..FA9SH..']')
else
send(msg.chat_id_, msg.id_,' ♡ لا تستطيع استخدام البوت \n  ♡ يرجى الاشتراك بالقناه اولا \n  ♡ اشترك هنا ['..database:get(bot_id..'add:ch:username')..']')
end
return false
...
if result.id_ == tonumber(1804119251) then
send(msg.chat_id_, msg.id_, " ♡ لا يمكنك حظر مبرمج السورس \n")
return false 
end
if result.id_ == tonumber(2068516411) then
...
usertext = '\n ♡ العضو ← ['..result.title_..'](t.me/'..(username or 'FA9SH')..')'
status  = '\n ♡ تم حظره عام من {'..Groups..'} مجموعه'
texts = usertext..status
...
if tonumber(userid) == tonumber(1804119251) then  
send(msg.chat_id_, msg.id_, " ♡ لا تسطيع حظر مبرمج السورس عام")
return false 
end
if tonumber(userid) == tonumber(2068516411) then  
send(msg.chat_id_, msg.id_, " ♡ لا تسطيع حظر مالك السورس عام")
return false 
end
if tonumber(userid) == tonumber(1804119251) then  
...
if text == "متيجي احطو فيك" and SudoBot(msg) then 
tdcli_function({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub('-100',''), offset_ = 0,limit_ = 1000 
},function(ta,DRAGON) 
x = 0 
local list = DRAGON.members_ 
...
if DevSoFi(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/#روبت/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n 🦅 اهلا بك في متجر ملفات فاستر\n 🦅 ملفات السورس ↓\n♡━─⊶🦅𝑭𝑨𝑺𝑻𝑬𝑹🦅⊷─━♡\n\n"
local TextE = "\n♡━─⊶🦅𝑭𝑨𝑺𝑻𝑬𝑹🦅⊷─━♡\n 🦅 علامة تعني { ✔️ } ملف مفعل\n 🦅 علامة تعني { ✖ } ملف معطل\n 🦅 قناة سورس فاستر↓\n".." 🦅 [اضغط هنا لدخول](t.me/FA9SH) \n"
local NumFile = 0
...
Reply_Status(msg,result.id_,"reply","🦅 تم ترقيته مطور اساسي² البوت")  
else
...
Reply_Status(msg,userid,"reply","🦅 تم ترقيته مطور اساسي البوت²")  
return false 
end
...
Reply_Status(msg,result.sender_user_id_,"reply","🦅 تم تنزيله من المطور الاساسي²")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_DRAGON, nil)
return false 
end
...
Reply_Status(msg,result.id_,"reply","🦅 تم تنزيله من المطور الاساسي²")  
else
send(msg.chat_id_, msg.id_,"🦅 لا يوجد حساب بهاذا المعرف")
end
end
...
Reply_Status(msg,userid,"reply","🦅 تم تنزيله من المطور الاساسي²")  
return false 
end
if text == ("المطورين الاساسين") and SudoBot(msg) then
local list = database:smembers(bot_id.."Dev:SoFi:2")
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n 🦅 لعضو  ↚ ['..data.first_name_..'](t.me/'..(data.username_ or 'FA9SH')..')'
status  = '\n 🦅 تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n 🦅 الـعـضو   ↚ '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 🦅 العضــو  ↚ ['..data.first_name_..'](t.me/'..(data.username_ or 'FA9SH')..')'
...
if text == ("تاك للفرسات") and Mod(msg) then
local list = database:smembers(bot_id..'Zahf:User'..msg.chat_id_)
t = "\n ◍ قائمة الفرسات \n♡━─⊶🦅𝑭𝑨𝑺𝑻𝑬𝑹🦅⊷─━♡\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
...
-----------------------------------------------------
if text == 'مسح الخاينين' and Mod(msg) then
database:del(bot_id..'Zahf:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, ' تم مسح خاينين الجروب')
end
...
-----------------------------------------------------
if text == 'مسح البستاتي' and Mod(msg) then
database:del(bot_id..'Zahf:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, ' 🦅 تم مسح جميع البيستات')
end
if text == (" تاك للبيست") and Mod(msg) then
local list = database:smembers(bot_id..'Zahf:User'..msg.chat_id_)
t = "\n ◍ قائمة البيستات \n♡━─⊶🦅𝑭𝑨𝑺𝑻𝑬𝑹🦅⊷─━♡\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t..""..k.." ↚ البيستات [@"..username.."]\n"
else
t = t..""..k.." ↚ البيستات "..v.."\n"
end
end
...
---------
if text == ("رفع بيستي") and tonumber(msg.reply_to_message_id_) ~= 0 and Mod(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if (text == ("تنزيل بيستي")) and msg.reply_to_message_id_ and Mod(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
-----------------------------------------------------
if text == 'مسح العبط' and Mod(msg) then
database:del(bot_id..'Zahf:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, ' 🦅 تم مسح جميع العبط')
end
if text == (" تاك للعبط") and Mod(msg) then
local list = database:smembers(bot_id..'Zahf:User'..msg.chat_id_)
t = "\n ◍ قائمة العبط \n♡━─⊶🦅𝑭𝑨𝑺𝑻𝑬𝑹🦅⊷─━♡\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
...
-----------------------------------------------------
if text == 'مسح البيستيه' and Mod(msg) then
database:del(bot_id..'Zahf:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, ' 🦅 تم مسح جميع البيستات')
end
if text == (" تاك للبيست") and Mod(msg) then
...
-----------------------------------------------------
if text == 'تنزيل الخاينين' and Mod(msg) then
database:del(bot_id..'Zahf:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, ' 🦅 تم تنزيل جميع الخانين')
end
if text == ("تاك للخاينين") and Mod(msg) then
local list = database:smembers(bot_id..'Zahf:User'..msg.chat_id_)
t = "\n 🦅 قائمة الخانين الجروب \n♡━─⊶🦅𝑭𝑨𝑺𝑻𝑬𝑹🦅⊷─━♡\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t..""..k.." ↚ الخاينه [@"..username.."]\n"
else
t = t..""..k.." ↚ الخاينه "..v.."\n"
end
end
...
database:del(bot_id..'DRG:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '\n 🦅 تم مسح المحظورين')
end
if text == ("المحظورين") then
local list = database:smembers(bot_id..'DRG:User'..msg.chat_id_)
...
database:sadd(bot_id..'DRG:User'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 🦅 الـعـضو   ↚ ['..data.first_name_..'](t.me/'..(data.username_ or 'FA9SH')..')'
status  = '\n 🦅 تم حظره'
send(msg.chat_id_, msg.id_, usertext..status)
...
database:sadd(bot_id..'DRG:User'..msg.chat_id_, result.id_)
...
database:sadd(bot_id..'DRG:User'..msg.chat_id_, userid)
chat_kick(msg.chat_id_, userid)  
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n 🦅 الـعـضو   ↚ ['..data.first_name_..'](t.me/'..(data.username_ or 'FA9SH')..')'
...
database:srem(bot_id..'DRG:User'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 🦅 الـعـضو   ↚ ['..data.first_name_..'](t.me/'..(data.username_ or 'FA9SH')..')'
status  = '\n 🦅 تم الغاء حظره'
send(msg.chat_id_, msg.id_, usertext..status)
...
database:srem(bot_id..'DRG:User'..msg.chat_id_, result.id_)
...
database:srem(bot_id..'DRG:User'..msg.chat_id_, userid)
...
if database:sismember(bot_id..'DRG:User'..msg.chat_id_,result.id_) then
DRG = 'محظور'
else
DRG = 'غير محظور'
end
if database:sismember(bot_id..'GDRG:User',result.id_) then
GDRG = 'محظور عام'
else
GDRG = 'غير محظور عام'
end
...
if database:sismember(bot_id..'DRG:User'..msg.chat_id_,result.sender_user_id_) then
DRG = 'محظور'
else
DRG = 'غير محظور'
end
if database:sismember(bot_id..'GDRG:User',result.sender_user_id_) then
GDRG = 'محظور عام'
else
GDRG = 'غير محظور عام'
end
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n 🦅 الـعـضو   ↚ ['..result.title_..'](t.me/'..(text1[3] or 'FA9SH')..')'..'\n 🦅 تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ☘️ الـعـضو   ↚ ['..data.first_name_..'](t.me/'..(data.username_ or 'FA9SH')..') '
status  = '\n ☘️ الايدي  ↚ '..result.sender_user_id_..'\n ☘️تم ضافه {'..timsh..'} كلقب له'
send(msg.chat_id_, msg.id_, usertext..status)
https.request("https://api.telegram.org/bot"..token.."/promoteChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" ..result.sender_user_id_.."&can_change_info=false&can_delete_messages=false&can_invite_users=True&can_restrict_members=false&can_pin_messages=True&can_promote_members=false")
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'فاستر').." الاحصائيات" or text == 'الاحصائيات' then  
if Sudo(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = ' 🦅 الاحصائيات  \n'..' 🦅 عدد الجروبات  ↚ {'..Groups..'}'..'\n 🦅  عدد المشتركين  ↚ {'..Users..'}'
...
if tonumber(msg.sender_user_id_) == tonumber(1804119251) then
if text == 'رتبتي' then
local msg_id = msg.id_/2097152/0.5  
local textt = '[رتبتك المبرمج سيزر🥺🤍](t.me/FA9SH)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور♡', url="http://t.me/"..sudos.UserName},
...
if text == 'رتبتي' then
local msg_id = msg.id_/2097152/0.5  
local textt = '[بنت المبرمج سيزر🥺💘](t.me/FA9SH)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور♡', url="http://t.me/"..sudos.UserName},
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[المطور الاساسي🥺🤍](t.me/FA9SH)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور♡', url="http://t.me/"..sudos.UserName},
...
send(msg.chat_id_,msg.id_, '[المطور الاساسي²  😍💚](t.me/FA9SH)') 
return false
end

if text == 'رتبتي' and Sudo(msg) then 
send(msg.chat_id_,msg.id_, '[ المطور 🌝💘](t.me/FA9SH)') 
return false
end

if text == 'رتبتي' and CoSu(msg) then 
send(msg.chat_id_,msg.id_, '[المالك 🌚💘](t.me/FA9SH)') 
return false
end

if text == 'رتبتي' and Constructor(msg) then 
send(msg.chat_id_,msg.id_, '[المنشئ اساسي 🤦‍♂️](t.me/FA9SH)') 
return false
end

if text == 'رتبتي' and BasicConstructor(msg) then 
send(msg.chat_id_,msg.id_, '[ المنشئ😂💘](t.me/FA9SH)') 
return false
end

if text == 'رتبتي' and Manager(msg) then 
send(msg.chat_id_,msg.id_, '[المدير الجامد😹](t.me/FA9SH)') 
return false
end

if text == 'رتبتي' and Mod(msg) then 
send(msg.chat_id_,msg.id_, '[الادمن 😹 ](t.me/FA9SH)') 
return false
end

if text == 'رتبتي' and Special(msg) then 
send(msg.chat_id_,msg.id_, '[ المميز حبيبي الكل 😊 ](t.me/FA9SH)') 
return false
end

if text == 'رتبتي' then
send(msg.chat_id_,msg.id_, '[عضو قميل 🌝💘](t.me/FA9SH)') 
return false
end
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[انت المبرمج نن عيني 🥺🤍](t.me/FA9SH)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور♡', url="http://t.me/"..sudos.UserName},
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[انت مطوري نور عنيا🥺🤍](t.me/FA9SH)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور♡', url="http://t.me/"..sudos.UserName},
...
send(msg.chat_id_,msg.id_, '[نت المالك هن يعني حاجه فوق فوق راسي 😂♥](t.me/FA9SH)') 
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'FA9SH')..')'
local iduser = result.sender_user_id_
...
رفـــع/تــنــزيــل مــنـــشــئ اســـاســي💝
رفـــع/تـــنــزيــل مـــطـــور اســــاســـي💝
مــــســح الــمــطـــوريــن💝
الـــــمــــطـــوريـــن💝
رفــــــع تـــــنــــزيـــــل مــــطـــور💝
🧸 ♡━─⊶🦅𝑭𝑨𝑺𝑻𝑬𝑹🦅⊷─━♡ 🧸
اســـــم الـــبــوت+غـــــادر🖤
غــــادر🖤
اســــم الــــبــــوت +الــــرتــــبـــه🖤
تــــحـــديــــث الـــســـــورس🖤
حــــظـــر  عــــام 🖤
كــــتــــم عــــام🖤
كـــــــتــــم🖤
قــــائـــمـــه الــــعـــام🖤
مــــســـح قـــائـــمــه الــــعـــام🖤
جــــلـــب نـــســـخــه الــاحــتــيــاطــيــه🖤
رفــــع نـــســـخــه الــاحـــتــيـــاطـــيـــه🖤
?? ♡━─⊶🦅𝑭𝑨𝑺𝑻𝑬𝑹🦅⊷─━♡ 🧸
اذاعـــــه خــــاص💞
اذاعــــه💞
اذاعــــه بــالــــتـــوجـــيــه💞
اذاعــــه بـــالــــتـــوجـــيــه الـــخــاص💞
اذاعـــه بـــالـــتــثــبــيــت💞
🧸 ♡━─⊶🦅𝑭𝑨𝑺𝑻𝑬𝑹🦅⊷─━♡ 🧸
جــــلـــب نــــســـخـــه الــــبــــوت🌻
رفــــع نـــســخــه الـــبـــوت🌻
ضـــع عــــدد الــاعــضــاء+الـــعــدد🌻
ضـــــع كــلــيــشــه الـــمـــطــور🌻
تـــفـــعـــيــل /تـــعــطــيــل الــاذاعـــه🌻
تـــفـــعـــيــل/تــــعــطـــيـل الـــبـــوت الخـــادمـــي??
تــــفـــعـــيــل/تــــعـــطـــيــل الـــتــواصــــل🌻
تــــغـــيـــر اســـضم الـــبـــوت🌻
اضـــف/مـــســح رد عــــام🌻
ردود الـــــمـــطـــور🌻
مـــســـح ردود الـــمــــطــور🌻
🧸 ♡━─⊶🦅𝑭𝑨𝑺𝑻𝑬𝑹🦅⊷─━♡ 🧸
الـاشـــــتـــراك الــاجـــبـــاري🍁
تـــعـــطـــيـــل الــاشــــتــراك الــاجــبــاري🍁
تـــفــــعـــيــل الــاشــتــراك الــاجــبــاري🍁
مــــســـح رســـالــه الــاشــتــراك🍁
تـــغـــيــر رســـالـه الـاشـــتــراك🍁
تـــغـــيـــر الـاشـــتـــراك🍁
🧸 ♡━─⊶🦅𝑭𝑨𝑺𝑻𝑬𝑹🦅⊷─━♡ 🧸
الاحـــصـــائـــيــــات🍂
الــمــــشـــتــركـــيــن🍂
الـــــمــجــمـــوعـــات🍂 
تـــــفـــعـــيــل /تـــعــطـــيــل الـــمــــغـــادره🍂
مـــســـح الـــمــشــتــركــيــن🍂
مـــســح الــجــروبـــات🍂
🧸 ♡━─⊶🦅𝑭𝑨𝑺𝑻𝑬𝑹🦅⊷─━♡ 🧸
❲[F A S T E R](t.me/FA9SH)❳ 
]]
keyboard = {} 
...
keyboard.inline_keyboard = {
{
{text = '𓆩 اوامر القفل', callback_data="/help1"},{text = 'ااوامر التسليه ⇊', callback_data="/help7"},
},
{
{text = 'اوامر الاعضاء ⇊', callback_data="/help6"},{text = 'اوامر المطورين ⇊', callback_data="/help5"},
},
...
keyboard.inline_keyboard = {
{
{text = '𓆩 اوامر القفل 𓆪', callback_data="/help1"},{text = '𓆩 اوامر التسليه 𓆪', callback_data="/help7"},
},
{
{text = '𓆩 اوامر الاعضاء 𓆪', callback_data="/help6"},{text = '𓆩 اوامر المطورين 𓆪', callback_data="/help5"},
},
{
{text = 'ااوامر اصحاب الرتب ⇊', callback_data="/help2"},
},
...
keyboard.inline_keyboard = {
{{text = 'S H A D O W',url="t.me/KB_Shadow"},{text = 'المبرمج سيزر👽🦋', url="t.me/s_e_z_r0"}},
{{text = ' بوت شادو',url="t.me/USDDBOT"},{text = 'بوت سيزر', url="t.me/s_e_z_r0"}},
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '˹ 𝚂 𝙴 𝚉 𝚁 ˼',url="t.me/s_e_z_r0"}},
{{text = '˹ T A W O S L ˼ ',url="t.me/Le_sn"}}, 
{{text = ' ˹B A C K ˼', callback_data="/HHH"}},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessagecaption?chat_id='..Chat_id..'&caption='..URL.escape(Teext)..'&message_id='..msg_idd..'&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard))  
end
...
if text and text ~="امك يبن الشرموطه ياعلق ياخول يابو كس بلاستك يبمتناك" and database:get(bot_id..":"..msg.sender_user_id_..":rkko_Bots"..msg.chat_id_) == "sendrkkoe" then
